...
file_path <- "/Users/chinelochukwuemeka/Desktop/McDaniel College/DATA MINING/mysample.csv"

write.csv(mysample, file ="/Users/chinelochukwuemeka/Desktop/McDaniel College/DATA MINING/mysample.csv")
...
arrange(date)  %>% 
filter(spi1<80)  %>% 
select(Index1 = spi1, Index2 = spi2, team1, team2) %>% 
summary() %>% 
print()
